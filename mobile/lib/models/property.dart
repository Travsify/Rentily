class Property {
  ...
  factory Property.fromJson(Map<String, dynamic> json) {
    ...
    return Property(
      ...
      partnerBusinessName: json['partnerBusinessName']?.toString() ?? json['partner_business_name']?.toString(),
      partnerCacNumber: json['partnerCacNumber']?.toString() ?? json['partner_cac_number']?.toString(),
