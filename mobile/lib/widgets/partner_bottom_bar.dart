        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              _buildNavItem(3, Icons.qr_code_scanner_rounded, Icons.qr_code_scanner_rounded, 'Gate Passes'),
              _buildNavItem(4, Icons.badge_outlined, Icons.badge_rounded, 'Profile'),
            ],
          ),
        ),
      ),
