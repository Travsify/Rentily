...
class _PartnerListingModalState extends State<PartnerListingModal> {
  ...
  void _handleSubmit() async {
    ...
    final newProperty = Property(
      ...
      partnerBusinessName: widget.user.role == 'partner' ? (widget.user.businessName ?? 'Apex Realty Partners Ltd') : null,
      partnerCacNumber: widget.user.role == 'partner' ? (widget.user.cacNumber ?? 'RC 1928374') : null,
      partnerCommissionRate: _purpose == 'rent' ? 0.025 : 0.02,
