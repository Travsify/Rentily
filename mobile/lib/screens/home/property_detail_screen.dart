...
import '../../widgets/escrow_checkout_modal.dart';
              ...
              OutlinedButton.icon(
                onPressed: () {
                  Share.share(
                    ...
                    'Live Verification: https://api.myrentilly.com/safety/inspection/$code',
                  );
                },
                    ...
                    Expanded(
                      ...
                      child: OutlinedButton.icon(
                        onPressed: () async {
                          ...
                          final ok = await ApiService.updatePropertyStatus(propertyId: prop.id, status: newStatus);
                          if (ok && mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  newStatus == 'unlisted'
                                      ? 'Unit unlisted from public marketplace.'
                                      : 'Unit relisted as active! 🚀',
                        ...
                        style: OutlinedButton.styleFrom(
                          side: BorderSide(color: prop.status == 'unlisted' ? const Color(0xFF16A34A) : Colors.red),
                          padding: const EdgeInsets.symmetric(vertical: 12),
