...
class _LandlordDigitalLeasesScreenState extends State<LandlordDigitalLeasesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> sampleLeases = [
      {
        'id': 'LSE-2026-8821',
        'propertyTitle': 'Luxury 3-Bedroom Waterfront Apartment',
        'address': 'Admiralty Way, Lekki Phase 1, Lagos',
        'tenantName': 'Oluwaseun Adeyemi',
        'tenantPhone': '+234 803 291 0021',
        'annualRent': 4500000.0,
        'caution': 450000.0,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        'LAGOS TENANCY LAW 2011 COMPLIANT',
                  ...
                  const SizedBox(height: 4),
                  Text(
                    'All leases generated on Rentilly are digitally signed, legally binding in Nigerian courts, and include automated move-in key handover escrow protection.',
