              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.BarcodeWidget(
                    ...
                    data: 'https://api.myrentilly.com/legal/notice/$tenantName',
                    width: 50,
                    height: 50,
                  ),
                ],
  ...
  void _showDeleteAccountDialog() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to permanently delete your Landlord account? All your personal information, property listings, and verification records will be permanently removed from the platform.\n\nNote: Any active tenancy agreements or pending escrow disbursements must be settled before account deletion.',
        ...
        child: ListView(
          ...
          children: [
            ...
            _buildTile(
              ...
              title: 'Landlord Tenancy Legal Desk',
