...
export const CreatorLeaderboardPortal: React.FC<{ onBackToAdmin?: () => void }> = ({ onBackToAdmin }) => {
      ...
      <header className="border-b border-emerald-950/40 bg-slate-900/80 backdrop-blur-md sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-2xl bg-emerald-950 border-2 border-amber-500/80 p-2 shadow-lg shadow-emerald-900/40 flex items-center justify-center">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2.5 py-0.5 text-[10px] font-mono font-bold uppercase tracking-wider bg-amber-500/20 text-amber-300 border border-amber-500/40 rounded-full">
                  contest.myrentilly.com
                </span>
              </div>
              <p className="text-xs text-slate-400">Official 50+ Creator Bounty &amp; Leaderboard Hub</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-xs font-bold text-slate-200 border border-slate-700 transition"
            ...
            <button
              ...
              className="px-4 sm:px-6 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-slate-950 font-extrabold text-sm shadow-lg shadow-emerald-500/20 flex items-center gap-2 transition-all transform hover:scale-105 active:scale-95"
            >
            ...
            {onBackToAdmin && (
              <button
                ...
                className="px-3 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-xs text-slate-300 border border-slate-700 flex items-center gap-1.5 transition"
              >
      ...
      <section className="relative overflow-hidden pt-12 pb-16 px-4 sm:px-6 lg:px-8 border-b border-emerald-950/60 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-emerald-950/40 via-slate-950 to-slate-950">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-bold tracking-wide uppercase mb-6">
            ...
            <span>Cluely Playbook Active &bull; ₦500,000+ Prize Pool</span>
          </div>
          ...
          <p className="text-slate-300 text-base sm:text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
            Post your Rentilly video on TikTok, Instagram Reels, or YouTube Shorts. Drop your link on contest.myrentilly.com,
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-20">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-5 backdrop-blur-xl shadow-xl">
            ...
            <span className="text-[11px] text-slate-400 font-medium">50+ Creators Competing</span>
          </div>
          ...
          <div className="bg-slate-900/90 border border-purple-900/40 rounded-2xl p-5 backdrop-blur-xl shadow-xl">
            ...
            <span className="text-[11px] text-purple-400/80 font-medium">Direct Bank Payouts</span>
          </div>
        </div>
      </section>
                ...
                {filtered.length === 0 && (
                  <tr>
                    <td colSpan={6} className="py-12 text-center text-slate-500">
                      No video submissions found matching your filters.
                    </td>
                  </tr>
                )}
              </tbody>
        ...
        <div className="bg-gradient-to-r from-emerald-950/60 to-slate-900/80 border border-emerald-900/40 rounded-3xl p-6 sm:p-10">
          <div className="max-w-3xl">
            <h2 className="text-xl sm:text-2xl font-black text-white mb-3">
              How the Rentilly Viral Creator Program Works
            </h2>
            <p className="text-slate-300 text-sm leading-relaxed mb-6">
              Rentilly is Nigeria’s modern rent &amp; tenancy platform by E-Homes Global Inclusive Limited.
              We are empowering 50+ creators to expose the agent extortion mafia, apartment catfishing,
              and showcase the seamless Rentilly mobile experience.
            </p>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-lg w-full p-6 sm:p-8 shadow-2xl relative max-h-[90vh] overflow-y-auto">
            ...
            <p className="text-xs text-slate-400 mb-6">
              Drop your live video link so our view tracker starts counting your views for the bounty.
            </p>
